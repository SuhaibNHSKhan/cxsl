...
#define cxsl__outstrsz CXSL__DEC(outstrsz)
...
size_t cxsl__outstrsz(size_t ret_sz, size_t buff_sz);
...
size_t cxsl__fnstrtrm(const char* str, size_t len, char* out, size_t sz);
...
size_t cxsl__lnstrcat(const char* str1, size_t len1, const char* str2, size_t len2);
size_t cxsl__lnstrtok(const char* str, size_t len, const char* delimiters, size_t dlen, const char** context);
size_t cxsl__lnstrtrm(const char* str, size_t len);
...
size_t cxsl__outstrsz(size_t ret_sz,size_t buff_sz)
{
    return ret_sz ? ret_sz - 1 : buff_sz - 1;
}
...
size_t cxsl__fnstrsub(const char* str,size_t len,size_t start_idx,char* out,size_t sz)
{
    cxsl__assert(str != NULL, "Parameter str cannot be NULL");
    cxsl__assert(out != NULL, "Parameter out cannot be NULL");
